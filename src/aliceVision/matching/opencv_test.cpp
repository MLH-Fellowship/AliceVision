...
/*
 * This is a unit test for the OpenCV implementation
 *
 */

// ----------------------- TESTING -----------------------

BOOST_AUTO_TEST_CASE(/* put the proper openCV shit here */)
{
    const float array[] = {0, 1, 2, 5, 6};
    // no 3, because it involve the same dist as 1,1

    // initialize matching structure for OpenCV
...
// ****** REMINDER: add a line for this test in the CMake File for matching
